...
object TaskParTraverseUnorderedSuite extends BaseTestSuite {
  ...
  test("IO.parTraverseUnordered should onError if one of the tasks terminates in error") { implicit s =>
  ...
  test("IO.parTraverseUnordered should run over an iterable") { implicit s =>
    val count = 10
  ...
  test("IO.parTraverseUnordered should be stack-safe on handling many tasks") { implicit s =>
    val count = 10000
  ...
  test("IO.parTraverseUnordered should be stack safe on success") { implicit s =>
  ...
  test("IO.parTraverseUnordered should log errors if multiple errors happen") { implicit s =>
  ...
  test("IO.parTraverseUnordered runAsync multiple times") { implicit s =>
    var effect = 0
  ...
  test("IO.parTraverseUnordered should wrap exceptions in the function") { implicit s =>
    val ex = DummyException("dummy")
