...
private[bio] object TaskRacePair {
  ...
  private final class Register[E, A, B](fa: IO[E, A], fb: IO[E, B]) extends ForkedRegister[E, RaceEither[E, A, B]] {

    def apply(context: IO.Context[E], cb: BiCallback[E, RaceEither[E, A, B]]): Unit = {
