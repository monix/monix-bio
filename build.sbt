...
lazy val microsite = project
  ...
  .settings {
    ...
    Seq(
      ...
      micrositeGithubRepo := "monix-bio",
      micrositeUrl := "https://monix.github.io/monix-bio",
      micrositeBaseUrl := "/monix-bio",
      micrositeDocumentationUrl := "https://monix.github.io/monix-bio/api/",
      ...
      micrositeExtraMdFiles := Map(
        ...
        file("README.md") -> ExtraMdFileConfig("index.md", "home", Map("permalink" -> "/", "title" -> "Home", "section" -> "home", "position" -> "0"))
      ),
